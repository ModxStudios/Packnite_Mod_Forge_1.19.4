...
public class CreateWorldScreen extends Screen {
   ...
   public static void openFresh(Minecraft p_232897_, @Nullable Screen p_232898_) {
      ...
      CreateWorldScreen createWorldScreen = new CreateWorldScreen(p_232897_, p_232898_, completablefuture.join().withDataConfiguration(new WorldDataConfiguration(new DataPackConfig(ImmutableList.of("vanilla"), ImmutableList.of()), FeatureFlags.DEFAULT_FLAGS)), Optional.of(WorldPresets.NORMAL), OptionalLong.empty());
      p_232897_.setScreen(createWorldScreen);
      createWorldScreen.tryApplyNewDataPacks(packrepository, true, createWorldScreen::openDataPackSelectionScreen);
   }
